...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   auth: () => (/* binding */ auth),\n/* harmony export */   portfolioVisitorId: () => (/* binding */ portfolioVisitorId)\n/* harmony export */ });\n/* harmony import */ var _jwt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../jwt */ \"./src/jwt/index.js\");\n/* harmony import */ var _utils_getToken__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/getToken */ \"./src/utils/getToken.js\");\n\n\nfunction auth(req, res, next) {\n  var token = (0,_utils_getToken__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(req);\n  if (!token) {\n    req.user = null;\n    return next(\"Please login first\");\n  }\n  (0,_jwt__WEBPACK_IMPORTED_MODULE_0__.parseToken)(token).then(function (u) {\n    req.user = {\n      _id: u._id,\n      email: u.email,\n      role: u.role\n    };\n    next();\n  })[\"catch\"](function (err) {\n    req.user = null;\n    next(\"Authorization, Please login first\");\n  });\n}\nfunction portfolioVisitorId(req, res, next) {\n  var id = req.cookies[\"rsl_portfolio_cookie\"];\n  if (!id) return next(\"Unauthorized\");\n  req.user = {\n    userId: id\n  };\n  next();\n}\n\n//# sourceURL=webpack://server/./src/middlewares/index.js?");
